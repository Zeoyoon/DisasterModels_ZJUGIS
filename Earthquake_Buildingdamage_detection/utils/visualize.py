...
def draw_bounding_box_on_image(
    ...
    draw_area_ratio = abs((right-left)/(im_width)) #计算目标框相对于原始图片宽度方向的比例大小，
    try:
        font = ImageFont.truetype("arial.ttf", int(32*draw_area_ratio)) #通过32*draw_area_ratio比例来修改数字大大小，根据实际来修改32的值
    except IOError:
