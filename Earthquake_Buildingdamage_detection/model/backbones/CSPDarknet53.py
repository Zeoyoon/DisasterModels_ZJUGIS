...
class CSPBlock(nn.Module):
    def __init__(
        ...
        self.block = nn.Sequential(
            Convolutional(in_channels, hidden_channels*2, 1),
            Convolutional(hidden_channels*2, out_channels*2, 3,groups=8),
...
class CSPDarknet53(nn.Module):
    def __init__(
        ...
        #    self.load_CSPdarknet_weights(weight_path) #可进行继续训练
        # else:
