...
class YoloV4Loss(nn.Module):
    ...
    def __cal_loss_per_layer(self, p, p_d, label, bboxes, stride):
        ...
        # loss ciou
        ious,ciou = tools.CIOU_xywh_torch(p_d_xywh, label_xywh) 
        ...
        loss_ciou = 10*label_obj_mask * bbox_loss_scale * (1.0 - ciou) * label_mix 
        #loss_ciou = 10000*(ious**1)*loss_ciou
        # loss confidence
        ...
        loss = loss_ciou + loss_conf + loss_cls #可更改loss权重，以适应三种loss不同的影响
