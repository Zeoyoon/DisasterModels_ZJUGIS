...
dirs = ['/exstorage/wzy/spacenet3/train/AOI_2_Vegas/',
        '/exstorage/wzy/spacenet3/train/AOI_3_Paris/',
        '/exstorage/wzy/spacenet3/train/AOI_4_Shanghai/',        
        '/exstorage/wzy/spacenet3/train/AOI_5_Khartoum/']
...
for dir in dirs:
    ...
    for file in sorted(os.listdir(image_dir)):
        ...
        msk_file = os.path.join(mask_dir, file)
        if os.path.exists(img_file) and os.path.exists(msk_file):
...
if __name__ == '__main__':
    ...
    snapshot_name = "hrnetOcr_650_seed{}".format(seed)
