...
from losses.buildformer.joint_loss import JointLoss
from losses.buildformer.soft_ce import SoftCrossEntropyLoss
from losses.buildformer.dice import DiceLoss
...
main_loss = JointLoss(SoftCrossEntropyLoss(smooth_factor=0.05, ignore_index=255),
