...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    # 一个配置初次训练使用
    model_path = '/exstorage/xyc/Mask_RCNN-master/unet-pytorch-main/model_data/unet_vgg_voc.pth'

    #同一个配置第一次训练之后获得last_epoch_weights.pth，后续在此基础上进行训练
    # model_path = "/exstorage/xyc/Mask_RCNN-master/unet-pytorch-main/logs/best_epoch_weights.pth"
    ...
    # ------------------------------------------------------------------#
    save_dir = '/exstorage/xyc/Mask_RCNN-master/unet-pytorch-main/logs'
    # ------------------------------------------------------------------#
