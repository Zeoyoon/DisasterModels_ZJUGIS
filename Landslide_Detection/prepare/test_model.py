...
from samples.landslide import landslide
...
if __name__ == '__main__':
    ...
    dataset.load_landslide(LANDSLIDE_DIR)
    ...
    weights_path = "../model/mask_rcnn_landslide_0020.h5"
    print("Loading weights ", weights_path)
    model.load_weights(weights_path, by_name=True)

    ## save prediction images
    result_image_folder = "../images/extraction_result"
    if not os.path.exists(result_image_folder):
        os.makedirs(result_image_folder)

    result_mask_folder = "../images/extraction_mask"
